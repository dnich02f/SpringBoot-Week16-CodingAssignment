...
public class DefaultJeepSalesService implements JeepSalesService {
  ...
  public List<Jeep> fetchJeeps(JeepModel model, String trim) {
    ...
    List<Jeep> jeeps = jeepSalesDao.fetchJeeps(model, trim); // this is returning an empty list if nothing is found
    
    // throw exception if no jeeps with model and trim are found
    if(jeeps.isEmpty()) {
